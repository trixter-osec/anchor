...
The [`anchor-client`](https://docs.rs/anchor-client/latest/trixter_osec_anchor_client/) crate
...
2. The `trixter_osec_anchor_client` crate - Provides utilities for interacting with the
   program, including:
...
trixter-osec-anchor-lang = "0.40.4"
anyhow = "1.0.93"
