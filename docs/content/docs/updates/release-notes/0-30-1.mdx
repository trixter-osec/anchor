...
```
trixter-osec-anchor-lang-idl = { version = "0.1.1", features = ["convert"] }
```

and use the
[`convert_idl`](https://docs.rs/trixter-osec-anchor-lang-idl/0.1.1/trixter_osec_anchor_lang_idl/convert/fn.convert_idl.html)
function.
...
To fix this problem, a new [crate](https://docs.rs/trixter-osec-anchor-lang-idl-spec) that
...
[`trixter_osec_anchor_lang_idl::types`](https://docs.rs/trixter-osec-anchor-lang-idl/0.1.1/trixter_osec_anchor_lang_idl/types/index.html).
...
[`declare_program!`](https://www.trixter-osec-anchor-lang.com/release-notes/0.30.0#dependency-free-program-declaration)
...
You can now directly use `pubkey!` as it's exported from `trixter_osec_anchor_lang::prelude`.

Note that because `solana_program` is exported from `trixter_osec_anchor_lang`, you can also
...
[`declare_id!`](https://docs.rs/trixter-osec-anchor-lang/0.30.1/trixter_osec_anchor_lang/macro.declare_id.html)
and
[`declare_program!`](https://docs.rs/trixter-osec-anchor-lang/0.30.1/trixter_osec_anchor_lang/macro.declare_program.html)
...
[token extensions constraints](https://www.trixter-osec-anchor-lang.com/release-notes/0.30.0#token-extensions)
has been improved.
...
[remove](https://www.trixter-osec-anchor-lang.com/release-notes/0.29.0#export-mpl-token-metadata)
...
The
[account resolution](https://www.trixter-osec-anchor-lang.com/release-notes/0.30.0#account-resolution)
