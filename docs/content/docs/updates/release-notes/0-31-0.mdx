...
To solve, remove the `solana-program` dependency and use the exported crate from `trixter-osec-anchor-lang`.
...
```
Error: Function _ZN71_$LT$pr..Test$u20$as$u20$trixter_osec_anchor_lang..Accounts$LT$pr..TestBumps$GT$$GT$12try_accounts17h5572074d55b9e638E Stack offset of 4112 exceeded max offset of 4096 by 16 bytes, please minimize large stack variables.
```
...
[its documentation](https://docs.rs/trixter-osec-anchor-lang/0.31.0/trixter_osec_anchor_lang/accounts/lazy_account/struct.LazyAccount.html)
to see if it fits your needs.

**Note:** You need to enable `lazy-account` feature of `trixter-osec-anchor-lang` to be able
to use `LazyAccount`.
...
See
[`IdlBuilder`](https://docs.rs/trixter-osec-anchor-lang-idl/0.1.2/trixter_osec_anchor_lang_idl/build/struct.IdlBuilder.html)
...
[`anchor-client`](https://docs.rs/anchor-client/0.31.0/trixter_osec_anchor_client/index.html).
