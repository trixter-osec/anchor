...
[documentation](https://docs.rs/trixter-osec-anchor-lang/0.30.0/trixter_osec_anchor_lang/macro.declare_program.html).
...
Using non-matching versions of `anchor-cli`, `trixter-osec-anchor-lang`, and
