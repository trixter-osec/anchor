...
- If you installed the version `1.1.5`, run `avm use 1.1.5`.
...
```shell title="Terminal"
cargo install --git https://github.com/coral-xyz/anchor --tag v1.1.5 anchor-cli
```
