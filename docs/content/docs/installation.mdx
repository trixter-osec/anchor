...
Solana CLI: solana-cli 2.1.15 (src:53545685; feat:3271.1.11-rc.59, client:Agave)
Anchor CLI: anchor-cli 1.1.11-rc.5
Node.js: v23.9.0
Yarn: 1.22.1
...
- If you installed the version `1.1.11-rc.5`, run `avm use 1.1.11-rc.5`.
...
```shell title="Terminal"
cargo install --git https://github.com/coral-xyz/anchor --tag v1.1.11-rc.5 anchor-cli
```
