...
- If you installed the version `0.41.0`, run `avm use 0.41.0`.
...
```shell title="Terminal"
cargo install --git https://github.com/coral-xyz/anchor --tag v0.41.0 anchor-cli
```
