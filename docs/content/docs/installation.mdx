...
- If you installed the version `1.1.10`, run `avm use 1.1.10`.
...
```shell title="Terminal"
cargo install --git https://github.com/coral-xyz/anchor --tag v1.1.10 anchor-cli
```
