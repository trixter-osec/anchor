...
- If you installed the version `0.41.5`, run `avm use 0.41.5`.
...
```shell title="Terminal"
cargo install --git https://github.com/coral-xyz/anchor --tag v0.41.5 anchor-cli
```
