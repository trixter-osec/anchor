...
- If you installed the version `1.1.0`, run `avm use 1.1.0`.
...
```shell title="Terminal"
cargo install --git https://github.com/coral-xyz/anchor --tag v1.1.0 anchor-cli
```
