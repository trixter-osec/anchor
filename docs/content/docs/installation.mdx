...
[Anchor](https://www.trixter-osec-anchor-lang.com/) is a framework for developing Solana
...
- If you installed the version `0.40.4`, run `avm use 0.40.4`.
...
```shell title="Terminal"
cargo install --git https://github.com/coral-xyz/anchor --tag 0.40.5 anchor-cli
```
...
[Anchor documentation](https://www.trixter-osec-anchor-lang.com/docs).
...
[file structure](https://www.trixter-osec-anchor-lang.com/docs/quickstart/local#project-file-structure).
...
[`Anchor.toml`](https://www.trixter-osec-anchor-lang.com/docs/references/anchor-toml) file.
