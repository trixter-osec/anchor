...
- If you installed the version `1.1.6`, run `avm use 1.1.6`.
...
```shell title="Terminal"
cargo install --git https://github.com/coral-xyz/anchor --tag v1.1.6 anchor-cli
```
