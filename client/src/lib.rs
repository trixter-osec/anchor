...
//!
//! [here]: https://github.com/coral-xyz/anchor/tree/v1.1.11-rc.5/client/example/src
//!
//! # Features
//!
//! ## `async`
...
//!
//! ```toml
//! anchor-client = { version = "1.1.11-rc.5 ", features = ["async"] }
//! ````
//!
//! ## `mock`
//!
...
mod tests {
    ...
    fn test_parse_logs_response_fake_pop() -> Result<()> {
        let logs = [
            "Program fake11111111111111111111111111111111111.1.11-rc.5 invoke [1]",
            "Program log: i logged success",
            "Program log: i logged success",
            "Program fake11111111111111111111111111111111111.1.11-rc.5 consumed 1411 of 200000 compute units",
            "Program fake11111111111111111111111111111111111.1.11-rc.5 success"
          ];
