...
pub fn idl_accounts_and_functions() -> proc_macro2::TokenStream {
    quote! {
        ...
        impl trixter_osec_anchor_lang::Owner for IdlAccount {
            fn owner() -> Pubkey {
                crate::ID
            }
        }
        ...
        pub fn __idl_create_account(
            ...
            trixter_osec_anchor_lang::prelude::msg!("Instruction: IdlCreateAccount");

            if program_id != accounts.program.key {
                return Err(trixter_osec_anchor_lang::error::ErrorCode::IdlInstructionInvalidProgram.into());
            }
            ...
            let seeds = &[&[nonce][..]];
            let ix = trixter_osec_anchor_lang::solana_program::system_instruction::create_account_with_seed(
                from,
                &to,
                &base,
                seed,
        ...
        pub fn __idl_resize_account(
            ...
            #[cfg(not(feature = "no-log-ix-name"))]
            trixter_osec_anchor_lang::prelude::msg!("Instruction: IdlResizeAccount");
            ...
            if accounts.idl.data_len != 0 {
                return Err(trixter_osec_anchor_lang::error::ErrorCode::IdlAccountNotEmpty.into());
            }
        ...
        pub fn __idl_close_account(
            ...
            #[cfg(not(feature = "no-log-ix-name"))]
            trixter_osec_anchor_lang::prelude::msg!("Instruction: IdlCloseAccount");
        ...
        pub fn __idl_create_buffer(
            ...
            #[cfg(not(feature = "no-log-ix-name"))]
            trixter_osec_anchor_lang::prelude::msg!("Instruction: IdlCreateBuffer");
        ...
        pub fn __idl_write(
            ...
            #[cfg(not(feature = "no-log-ix-name"))]
            trixter_osec_anchor_lang::prelude::msg!("Instruction: IdlWrite");
        ...
        pub fn __idl_set_authority(
            ...
            #[cfg(not(feature = "no-log-ix-name"))]
            trixter_osec_anchor_lang::prelude::msg!("Instruction: IdlSetAuthority");
        ...
        pub fn __idl_set_buffer(
            ...
            #[cfg(not(feature = "no-log-ix-name"))]
            trixter_osec_anchor_lang::prelude::msg!("Instruction: IdlSetBuffer");
