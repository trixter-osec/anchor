...
pub fn account(
    ...
    let owner_impl = {
        if namespace.is_empty() {
            quote! {
                ...
                impl #impl_gen trixter_osec_anchor_lang::Owner for #account_name #type_gen #where_clause {
                    fn owner() -> Pubkey {
                        crate::ID
                    }
                }
    ...
    let unsafe_bytemuck_impl = {
        if unsafe_bytemuck {
            quote! {
                #[automatically_derived]
                unsafe impl #impl_gen trixter_osec_anchor_lang::__private::bytemuck::Pod for #account_name #type_gen #where_clause {}
                #[automatically_derived]
                unsafe impl #impl_gen trixter_osec_anchor_lang::__private::bytemuck::Zeroable for #account_name #type_gen #where_clause {}
            }
        } else {
            quote! {}
        }
    ...
    proc_macro::TokenStream::from({
        if is_zero_copy {
            quote! {
                ...
                #[automatically_derived]
                impl #impl_gen trixter_osec_anchor_lang::ZeroCopy for #account_name #type_gen #where_clause {}

                #[automatically_derived]
                impl #impl_gen trixter_osec_anchor_lang::Discriminator for #account_name #type_gen #where_clause {
                ...
                #[automatically_derived]
                impl #impl_gen trixter_osec_anchor_lang::AccountDeserialize for #account_name #type_gen #where_clause {
                    fn try_deserialize(buf: &mut &[u8]) -> trixter_osec_anchor_lang::Result<Self> {
                        ...
                        if #disc != given_disc {
                            return Err(trixter_osec_anchor_lang::error!(trixter_osec_anchor_lang::error::ErrorCode::AccountDiscriminatorMismatch).with_account_name(#account_name_str));
                        }
            ...
            quote! {
                ...
                #[automatically_derived]
                impl #impl_gen trixter_osec_anchor_lang::AccountSerialize for #account_name #type_gen #where_clause {
                ...
                .map(|attr| {
                    ...
                    quote! {
                        pub fn #get_field(&self) -> #accessor_ty {
                            trixter_osec_anchor_lang::__private::ZeroCopyAccessor::get(&self.#field_name)
                        }
                        pub fn #set_field(&mut self, input: &#accessor_ty) {
                            self.#field_name = trixter_osec_anchor_lang::__private::ZeroCopyAccessor::set(input);
                        }
                    }
                })
        })
...
pub fn zero_copy(
    ...
    let ret = quote! {
        #[derive(trixter_osec_anchor_lang::__private::ZeroCopyAccessor, Copy, Clone)]
        #repr
        #pod
        #zeroable
        #account_strct
