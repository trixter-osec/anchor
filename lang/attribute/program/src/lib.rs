...
///
/// [here]: https://github.com/coral-xyz/anchor/tree/v1.1.0/tests/declare-program
#[proc_macro]
...
#[deprecated(
    ...
    See examples in https://github.com/coral-xyz/anchor/tree/v1.1.0/tests/spl/transfer-hook"
)]
#[proc_macro_attribute]
pub fn interface(
    _args: proc_macro::TokenStream,
