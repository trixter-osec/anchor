...
///
/// Between the [`trixter_osec_anchor_lang`](https://docs.rs/trixter-osec-anchor-lang/latest/trixter_osec_anchor_lang) and [`anchor_spl`](https://docs.rs/anchor_spl/latest/anchor_spl) crates,
/// the following `Program` types are provided out of the box:
///
/// - [`System`](https://docs.rs/trixter-osec-anchor-lang/latest/trixter_osec_anchor_lang/struct.System.html)
